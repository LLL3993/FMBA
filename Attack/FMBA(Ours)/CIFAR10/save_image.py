...
# 下载CIFAR-10训练集数据
trainset = torchvision.datasets.CIFAR10(root='/Users/kayle/PycharmProjects/Muti-Trigger For Clean-Label Attack/Data/CIFAR10', train=True,
...
if cat_images:
    ...
    # 生成与图片形状相同的随机噪声
    noise = torch.load('/Users/kayle/PycharmProjects/Muti-Trigger For Clean-Label Attack/CIFAR10/FMBA/trigger/target0.npy')  # 标准差为0.1的正态分布噪声
    # noise_2 = torch.load('/Users/kayle/PycharmProjects/Muti-Trigger For Clean-Label Attack/CIFAR10/FMBA/trigger/target1.npy')  # 标准差为0.1的正态分布噪声
    # noise = fussion_noise(noise_1, noise_2, 0.5)
    # print(noise.shape)

    # 将噪声添加到图片上
    noisy_image_tensor = cat_image_tensor + noise[0] * 0.1
