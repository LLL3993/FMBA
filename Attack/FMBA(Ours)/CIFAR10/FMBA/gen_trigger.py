...
def main():
        ...
        # load model
        ckpt = torch.load("/Users/kayle/PycharmProjects/model_train/checkpoint/model_pretrain_CIFAR10.pth")
        ...
        generate_model.fc = nn.Linear(generate_model.fc.in_features, 10)  # CIFAR-10有10个类别
        ...
        init_train_dataset = torchvision.datasets.CIFAR10(root=data_path, train=True, download=True, transform=transform_train)
        ...
        torch.save(best_noise, 'trigger/target0.npy')
