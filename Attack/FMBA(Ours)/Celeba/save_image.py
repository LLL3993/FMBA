...
# 下载CIFAR-10训练集数据
trainset = CelebA('Train', transforms=transform_tensor)
...
if cat_images:
    ...
    # 生成与图片形状相同的随机噪声
    noise = torch.load('/Users/kayle/PycharmProjects/Muti-Trigger For Clean-Label Attack/Celeba/trigger/target0.npy')  # 标准差为0.1的正态分布噪声
    # noise_2 = torch.load('/Users/kayle/PycharmProjects/Muti-Trigger For Clean-Label Attack/Celeba/trigger/target2.npy')  # 标准差为0.1的正态分布噪声
    ...
    # 保存带噪声的图片
    noisy_image_pil.save('celeba_target_image.png')
