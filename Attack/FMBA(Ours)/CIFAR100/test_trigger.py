...
def main():
    ...
    fussion_trigger = fussion_noise(noise_1, noise_2, 0.5)
    ...
    test_model.fc = nn.Linear(test_model.fc.in_features, 100)  # CIFAR-100有100个类别
    ...
    original_train = torchvision.datasets.CIFAR100(root=data_path, train=True, download=False, transform=transform_tensor)
    original_test = torchvision.datasets.CIFAR100(root=data_path, train=False, download=False, transform=transform_tensor)
    ...
    dataset_train = torchvision.datasets.CIFAR100(root=data_path, train=True, download=False, transform=transform_train)
    ...
    dataset_test = torchvision.datasets.CIFAR100(root=data_path, train=False, download=False, transform=transform_test)
